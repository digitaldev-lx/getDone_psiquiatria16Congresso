            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-offset-2" style="margin-left: 200px">
                    ...
                    <h3 class="inscricoes-sub-lead">
                        <ul style="margin-top: 10px;list-style-type: none; line-height: 25px" class="ul-info">
                            <li>
                    ...
                    <div class="col-xs-12 col-md-12 slider-container-button" style="margin: unset!important;">
                        <a href="https://eventbase.pt/EventBase/Login/LoginGetDone.aspx" class="btn btn-primary" style="float:left;background: #237088ff; margin-left: -25px">SUBMETER ABSTRACT <i class="fa-solid fa-angle-right fa-xl"></i></a>
                    </div>
