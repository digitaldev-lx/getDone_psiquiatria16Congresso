...
<div class="fh5co-parallax">
    <div class="slider-sppsm-logo">
        <img src="<?php echo e(asset("images/sppsm_logo.png")); ?>" alt="sppsm" />
    </div>
    <div class="slider-container">
        ...
        <a href="#" class="btn btn-primary">EFECTUAR INSCRIÇÃO <i class="glyphicon glyphicon-arrow-right" style="margin-left: 5px"></i></a>
    </div>
...
<?php /**PATH /var/www/html/resources/views/layout/partials/slider.blade.php ENDPATH**/ ?>