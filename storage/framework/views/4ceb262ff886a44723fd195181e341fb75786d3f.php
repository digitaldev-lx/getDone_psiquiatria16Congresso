        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-2 col-md-offset-1">
                    <img alt="Amelia Fiske" class="doctor-img-individual" src="<?php echo e(asset("images/convidados/IRMGARD_EMMELHAINZ.jpg")); ?>"/>
                    <img src="<?php echo e(asset("images/sppsm_logo.png")); ?>" style="width: 150px; float: left; margin-top:35vh" alt="sppsm"/>
                </div>
                <div class="col-xs-12 col-md-6">
                    <h2 class="fh5co-section-convidados">Irmgard Emmelhainz</h2>
                    <h4>MEXICO</h4>
                    <p>Irmgard Emmelhainz is a professor, writer, researcher and translator based in Anahuac Valley
...
<?php echo $__env->make("layout.index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/convidados/irmgard-emmelhainz.blade.php ENDPATH**/ ?>